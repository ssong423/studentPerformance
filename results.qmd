...
## **Part 1: Overall Academic Trends**
...
## **Part 2: The Impact of Family Background on Final Grades**
...
### **1. Impact of Parental Education Levels**
...
### **2. Influence of Family Relationships**
...
Family relationship quality clearly influences students' academic performance, with stronger relationships correlating with better outcomes. Students with "Very Good" family relationships cluster around higher grades (closer to 20) and exhibit tighter distributions, indicating both better performance and greater consistency. Conversely, those with "Very Poor" or "Poor" relationships show broader distributions and lower grades (closer to 0-10), likely reflecting external challenges or instability affecting their academic success.

Students with "Average" or "Good" family relationships fall into a transitional zone, displaying more balanced grade distributions with peaks around the middle grades (10-15). While these groups perform better than students with poorer relationships, they do not reach the consistency or high performance seen in the "Very Good" category.

Despite these trends, some overlap exists in the middle-grade range (10-15), indicating that family relationship quality is not the sole determinant of academic performance. Other factors likely contribute to this variability, suggesting the need for further analysis to fully understand the drivers of academic success.

------------------------------------------------------------------------

### **3. Guardianship and Grade Distribution**
...
>>>>>>> 8933e5d65f5160f7a035ba0b3e9ea342775c14a1
```{r}
library(ggplot2)
library(tidyr)
...
## **Part 3: Individual Factors Influencing Academic Performance**
...
### 1. Absences vs final grades by Failures and Gender
...
### **2. Health Status and Grade Distribution**
...
## **Part4. Background Variables and Categorical Analysis**
...
### 1. Impact of Support Types on G3 Classification

This mosaic plot investigates the combined impact of **family support (famsup)**, **school support (schoolsup)**, and **aspirations for higher education (higher)** on students' G3 grade group classifications: High, Medium, and Low.
...
Students who aspire to higher education are significantly more likely to achieve "High" or "Medium" grades, with a substantial reduction in "Low" grades compared to those without such aspirations. This trend persists across various combinations of family and school support, suggesting that aspirations for higher education play a critical role in driving academic performance.

**Support Systems**

-   **Family Support**: Students receiving family support exhibit a slight increase in "Medium" grades but do not show a notable improvement in achieving "High" grades compared to those without family support.

-   **School Support**: The impact of school support is more pronounced, leading to a noticeable reduction in "Low" grades and a corresponding increase in "Medium" and "High" grades. This suggests that school-provided resources or guidance may help mitigate challenges faced by struggling students.

**Combined Effects**\
The combination of aspirations for higher education with either family or school support results in the most favorable outcomes. Students in this group achieve a higher proportion of "High" grades compared to others. In contrast, those lacking both aspirations and support are disproportionately represented in the "Low" grade category, indicating the compounded negative impact of limited support and motivation.

#### **Implications**:

These observations highlight the importance of fostering aspirations for higher education and providing robust support systems, particularly within schools. While family support has a moderate influence, school support appears more impactful in reducing the likelihood of poor academic outcomes. Interventions should focus on enhancing school support mechanisms and encouraging higher education aspirations to improve overall student performance, especially for those at risk of falling into the "Low" grade category.
...
1.  **Gender Distribution**:
    ...
    -   There is a higher proportion of female students compared to males.

    -   Gender does not appear to significantly influence other variables like school or family support.

2.  **Support Relationships**:

    -   Students with aspirations for higher education are more likely to have family and school support.

    -   Interestingly, students without family support still show some inclination towards school support, indicating the importance of school intervention in such cases.

3.  **Activity and Support**:

    -   Participation in extracurricular activities (activities = yes) is positively associated with both aspirations for higher education and family support. This suggests a broader support network for students actively engaged in school activities.

4.  **Nursery Attendance and Higher Education**:

    -   A significant proportion of students who attended nursery school also aspire to higher education. This could indicate a link between early education and long-term academic aspirations.

#### **Implications**:

This analysis highlights the intricate relationships between categorical variables and their potential influence on student outcomes. The overlap between support systems, aspirations, and extracurricular involvement emphasizes the need for a holistic approach to improving student performance, particularly through fostering aspirations for higher education and enhancing support systems.

### **Implications and Conclusion of Section 4**
...
## Part5. Multivariate Analysis and Comprehensive Patterns
...
### 1. Parallel Coordinate Plot - Academic and Behavioral Variables by School Choice Reason

This plot provides a detailed view of academic and behavioral variables for students grouped by their school choice reasons: **course**, **home**, **other**, and **reputation**.
...
The **reputation** group shows the highest academic performance (G1, G2, G3) and parental education levels (Medu, Fedu). These students also exhibit lower levels of absences and healthier behaviors (e.g., lower alcohol consumption). This group demonstrates a consistent pattern of high achievement and supportive family environments.

The **home** group exhibits moderate grades and relatively good health, aligning with low travel time and absenteeism. This suggests that proximity to school might positively influence both attendance and academic performance.

Students in the **other** group show the lowest grades and higher variability across most variables, such as absenteeism and alcohol consumption. This group's behavior and performance patterns indicate potential external challenges or lack of motivation.

Finally, the **course** group displays moderate performance, with notable variation in study time and health metrics, suggesting a balanced but less focused academic profile compared to the reputation group.
...
### 2. PCA Biplot - Variables and G3 Grade Groups
...
The first principal component (PC1) separates students primarily based on academic variables like **study time**, **Medu**, and **Fedu**. The **High** G3 group aligns closely with these variables, indicating their strong positive impact on academic performance.

The second principal component (PC2) highlights behavioral variables such as **alcohol consumption (Dalc, Walc)** and **failures**, which are negatively correlated with grades. The **Low** G3 group clusters near these variables, reflecting their detrimental effects on academic success.

Key variables like **health**, **famrel**, and **absences** contribute to grade variability but are more neutral, aligning with the **Medium** G3 group. These variables highlight the balancing factors influencing moderate performance levels.
...
# 绘制散点图
ggplot(data, aes(x = absences, y = G3, color = studytime)) +
  geom_point(alpha = 0.7, size = 3) +  # 添加散点
  facet_wrap(~ famrel, labeller = labeller(famrel = c(
    "1" = "Very Poor",
    "2" = "Poor",
    "3" = "Average",
    "4" = "Good",
  ...
  #scale_color_gradient(low = "blue", high = "red") +  # 学习时间的颜色渐变
  theme_minimal(base_size = 14) +
  labs(
    title = "Absences vs Final Grades by Family Relationship",
    x = "Absences",
    y = "Final Grades (G3)",
    color = "Study Time (hours)"
  )

```

```{r}
ggplot(data, aes(x = studytime, y = G3, color = higher)) +
  geom_point(alpha = 0.7, size = 2) +
  scale_color_manual(values = c("yes" = "darkgreen", "no" = "purple"), name = "Higher Education") +
  theme_minimal(base_size = 14) +
  labs(
    title = "Study Time vs Final Grades by Higher Education Aspiration",
    x = "Study Time (hours/day)",
    y = "Final Grades (G3)",
    color = "Aspiration"
  )
...
```{r}
ggplot(data, aes(x = activities, fill = romantic)) +
  geom_bar(position = "dodge", aes(fill = romantic)) +
  facet_wrap(~ higher) +  # 按 higher 分面
  scale_fill_manual(values = c("yes" = "pink", "no" = "blue"), name = "Romantic Relationship") +
  theme_minimal(base_size = 14) +
  labs(
    title = "Extracurricular Activities and Romantic Relationship by Higher Education Aspiration",
    x = "Participation in Activities",
    y = "Count",
    fill = "Romantic"
  )
...
ggplot(data) +
  geom_mosaic(aes(weight = 1, x = product(higher, romantic), fill = activities)) +
  #scale_fill_manual(name = "Activities") +
  theme_minimal(base_size = 14) +
  labs(
    title = "Higher Education Aspiration with Activities and Romantic Relationship",
    x = "Higher Education Aspiration and Romantic Relationship",
    y = "Proportion",
    fill = "Participation in Activities"
  )
